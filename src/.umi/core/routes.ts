...
import { ApplyPluginsType, dynamic } from '/Users/juwang1/PG/test/my/riskUI/node_modules/umi/node_modules/@umijs/runtime';
...
export function getRoutes() {
  const routes = [
  {
    ...
    "component": dynamic({ loader: () => import(/* webpackChunkName: '.umi__plugin-openapi__openapi' */'/Users/juwang1/PG/test/my/riskUI/src/.umi/plugin-openapi/openapi.tsx'), loading: LoadingComponent})
  },
  {
    "path": "/",
    "component": dynamic({ loader: () => import(/* webpackChunkName: '.umi__plugin-layout__Layout' */'/Users/juwang1/PG/test/my/riskUI/src/.umi/plugin-layout/Layout.tsx'), loading: LoadingComponent}),
    "routes": [
      {
        "path": "/~demos/:uuid",
        "layout": false,
        ...
        "component": ((props) => dynamic({
          loader: async () => {
            ...
            const { default: getDemoRenderArgs } = await import(/* webpackChunkName: 'dumi_demos' */ '/Users/juwang1/PG/test/my/riskUI/node_modules/@umijs/preset-dumi/lib/plugins/features/demo/getDemoRenderArgs');
      ...
      },
      {
        ...
        "layout": false,
        "path": "/~docs",
        "wrappers": [dynamic({ loader: () => import(/* webpackChunkName: 'wrappers' */'../dumi/layout'), loading: LoadingComponent}), dynamic({ loader: () => import(/* webpackChunkName: 'wrappers' */'/Users/juwang1/PG/test/my/riskUI/node_modules/dumi-theme-default/es/layout.js'), loading: LoadingComponent})],
        "routes": [
          {
            "path": "/~docs",
            "component": dynamic({ loader: () => import(/* webpackChunkName: 'README.md' */'/Users/juwang1/PG/test/my/riskUI/README.md'), loading: LoadingComponent}),
            "exact": true,
            "meta": {
              "locale": "en-US",
              "order": null,
          ...
          },
          {
            ...
            "component": dynamic({ loader: () => import(/* webpackChunkName: 'components__index.md' */'/Users/juwang1/PG/test/my/riskUI/src/components/index.md'), loading: LoadingComponent}),
            "exact": true,
            "meta": {
            ...
            "routes": [
              {
                "name": "login",
                "path": "/user/login",
                "component": dynamic({ loader: () => import(/* webpackChunkName: 'p__user__Login' */'/Users/juwang1/PG/test/my/riskUI/src/pages/user/Login'), loading: LoadingComponent}),
                "exact": true
              }
            ]
          },
